...
# Question 4, Load the housing data from UCI, following the example in the lecture notes.
housing <- read.table("http://archive.ics.uci.edu/ml/machine-learning-databases/housing/housing.data")
names(housing) <- c("crim","zn","indus","chas","nox","rm","age","dis","rad","tax","ptratio","b","lstat","medv")

# Question 5, Add new features to the data set by creating 6th degree polynomials of each of the
# features, as well as 3rd degree interactions of each.
...
# Question 6, estimate a LASSO model to predict
...
# There is an error: Error in get.rmse(prediction$data$truth, prediction$data$response) : 
#  could not find function "get.rmse"

# Trained parameter estimates
getLearnerModel(finalModel)$beta

#Question 7 estimate a ridge regression model where again the penalty parameter λ is tuned by 6-fold CV.
...
# Question 8, now estimate the elastic net model.
# Search over penalty parameter lambda and force elastic net parameter to be 0 (ridge)
